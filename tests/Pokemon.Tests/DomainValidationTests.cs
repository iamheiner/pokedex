...
{
    /// <summary>
    /// Comprueba que un movimiento necesita un nombre válido.
    /// </summary>
    [Theory]
    [InlineData(null)]
    [InlineData("")]
    ...
    /// <summary>
    /// Comprueba que la potencia fuera del intervalo permitido se rechaza.
    /// </summary>
    [Theory]
    [InlineData(0)]
    [InlineData(-1)]
    ...
    /// <summary>
    /// Comprueba que los valores extremos permitidos de potencia son válidos.
    /// </summary>
    [Theory]
    [InlineData(1)]
    [InlineData(250)]
    ...
    /// <summary>
    /// Comprueba que un movimiento no acepta tipos ajenos a la enumeración.
    /// </summary>
    [Fact]
    public void MoveRejectsUndefinedType() => Assert.Throws<ArgumentOutOfRangeException>(() => new Move("Hit", 40, (PokemonType)999));

    /// <summary>
    /// Comprueba que un participante rechaza niveles fuera del intervalo permitido.
    /// </summary>
    [Theory]
    [InlineData(0)]
    [InlineData(101)]
    ...
    /// <summary>
    /// Comprueba que un participante acepta los niveles mínimo y máximo permitidos.
    /// </summary>
    [Theory]
    [InlineData(1)]
    [InlineData(100)]
    ...
    /// <summary>
    /// Comprueba que la salud actual respeta los límites de su salud total.
    /// </summary>
    [Theory]
    [InlineData(-1)]
    [InlineData(101)]
    ...
    /// <summary>
    /// Comprueba que la salud actual puede ser cero o igual a la salud total.
    /// </summary>
    [Theory]
    [InlineData(0)]
    [InlineData(100)]
    ...
    /// <summary>
    /// Comprueba los límites de cada estadística del participante.
    /// </summary>
    [Theory]
    ...
    /// <summary>
    /// Comprueba que un participante requiere un identificador no vacío.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Comprueba que un participante no acepta tipos ajenos a la enumeración.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Comprueba que un participante necesita un nombre válido.
    /// </summary>
    [Theory]
    ...
    /// <summary>
    /// Comprueba que se admiten cuatro movimientos y que la colección queda protegida frente a cambios externos.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Comprueba que los nombres de movimientos duplicados se detectan sin distinguir mayúsculas.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Comprueba que un movimiento nulo no puede pertenecer al participante.
    /// </summary>
    [Fact]
    public void NullMoveIsInvalid() => Assert.Throws<ArgumentException>(() => Create(moves: [null!]));

    /// <summary>
    /// Comprueba que la colección de movimientos no puede ser nula.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Comprueba que la calculadora rechaza participantes nulos.
    /// </summary>
    [Theory]
    ...
    /// <summary>
    /// Construye un participante con valores válidos y parámetros configurables para probar sus límites.
    /// </summary>
