...
internal sealed class BattleTestClient(DatabaseConnectionFactory connections)
{
    ...
    /// <summary>Guarda una partida mediante los repositorios SQL y la unidad de trabajo real de la prueba.</summary>
    ...
    /// <summary>Recupera una partida SQL mediante una sesión de lectura real.</summary>
    ...
    /// <summary>Actualiza una partida SQL mediante una operación de la unidad de trabajo real.</summary>
