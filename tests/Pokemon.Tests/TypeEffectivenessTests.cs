...
{
    /// <summary>
    /// Carga los casos independientes de efectividad entre tipos de movimiento y defensor.
    /// </summary>
    ...
    /// <summary>
    /// Comprueba que la efectividad calculada coincide con la tabla esperada del enunciado.
    /// </summary>
    [Theory]
    ...
    /// <summary>
    /// Comprueba que los datos de prueba contienen exactamente una vez cada combinación de tipos.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Comprueba que la tabla de efectividad rechaza tipos desconocidos.
    /// </summary>
    [Theory]
    [InlineData(-1, 0)]
    [InlineData(0, 999)]
