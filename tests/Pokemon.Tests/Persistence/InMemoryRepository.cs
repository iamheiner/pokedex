...
/// <summary>
/// Comparte las operaciones básicas sobre el estado en memoria de los repositorios de prueba.
/// </summary>
internal abstract class InMemoryRepository<T>(Func<T, Guid> id, Action ensure) where T : class
{
    ...
    /// <summary>
    /// Devuelve el resultado después de comprobar que la sesión está activa y la operación no está cancelada.
    /// </summary>
    ...
    /// <summary>
    /// Inserta o reemplaza un agregado en el estado de la operación de prueba.
    /// </summary>
    ...
    /// <summary>
    /// Elimina el agregado indicado del estado de la operación de prueba.
    /// </summary>
    ...
    /// <summary>
    /// Selecciona el tramo solicitado de una secuencia previamente ordenada.
    /// </summary>
