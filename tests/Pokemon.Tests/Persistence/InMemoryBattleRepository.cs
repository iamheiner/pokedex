...
/// <summary>
/// Simula un repositorio de partidas en memoria con actualizaciones atómicas exclusivamente para las pruebas.
/// </summary>
public sealed class InMemoryBattleRepository : IBattleRepository, IBattleReader, IDisposable
{
    ...
    /// <summary>
    /// Busca la partida en el estado de prueba o informa de que no existe.
    /// </summary>
    ...
    /// <summary>
    /// Libera el semáforo utilizado para coordinar el acceso al repositorio de prueba.
    /// </summary>
