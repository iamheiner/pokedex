...
/// <summary>
/// Doble transaccional de pruebas: copia agregados inmutables y publica solo al confirmar.
/// </summary>
public sealed class InMemoryUnitOfWork : IUnitOfWork, IReadSession, IDisposable
{
    ...
    /// <summary>
    /// Inicializa la unidad de trabajo de prueba y carga opcionalmente el catálogo inicial.
    /// </summary>
    ...
    /// <summary>
    /// Ejecuta una consulta sobre una copia coherente del estado de prueba sin publicar modificaciones.
    /// </summary>
    ...
    /// <summary>
    /// Ejecuta un comando sobre una copia y publica su estado solo si termina sin errores ni cancelación.
    /// </summary>
    ...
    /// <summary>
    /// Libera el semáforo que coordina las operaciones de la unidad de trabajo de prueba.
    /// </summary>
    ...
    private sealed class Snapshot(bool readOnly = false) : IRepositoryScope
    {
        ...
        /// <summary>
        /// Rechaza el acceso a una copia transaccional de prueba que ya está cerrada.
        /// </summary>
        private void Ensure() => ObjectDisposedException.ThrowIf(closed, this);
        /// <summary>
        /// Marca la copia transaccional de prueba como cerrada.
        /// </summary>
        public void Close() => closed = true;
        /// <summary>
        /// Obtiene un lector de la copia transaccional utilizada por la prueba.
        /// </summary>
        public TReader GetReader<TReader>() where TReader : class, IReadRepository => Resolve<TReader>();
        /// <summary>
        /// Obtiene un escritor de prueba y rechaza su resolución en una copia de solo lectura.
        /// </summary>
        ...
        /// <summary>
        /// Crea o reutiliza el doble de repositorio correspondiente al contrato solicitado.
        /// </summary>
        ...
        /// <summary>
        /// Copia los agregados inmutables a un nuevo estado transaccional independiente.
        /// </summary>
    ...
    /// <summary>
    /// Gestiona partidas dentro de la copia transaccional de estado utilizada por las pruebas.
    /// </summary>
