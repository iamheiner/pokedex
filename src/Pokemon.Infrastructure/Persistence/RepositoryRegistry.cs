...
/// <summary>
/// Mantiene las fábricas que permiten añadir repositorios sin modificar la unidad de trabajo.
/// </summary>
internal sealed class RepositoryRegistry
{
    /// <summary>
    /// Asocia el tipo de implementación con la fábrica que crea el repositorio dentro de una operación.
    /// </summary>
    ...
    /// <summary>
    /// Asocia una fábrica a sus contratos de repositorio y devuelve el registro para encadenar configuraciones.
    /// </summary>
    ...
    /// <summary>
    /// Obtiene la fábrica asociada al contrato o informa de que no está registrado.
    /// </summary>
    ...
    /// <summary>
    /// Configura las fábricas de los repositorios de la aplicación sin crear sus instancias.
    /// </summary>
