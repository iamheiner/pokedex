...
/// <summary>
/// Consulta y persiste partidas completas, con bloqueo por fila al actualizar dentro de la unidad de trabajo.
/// </summary>
internal sealed class BattleRepository(DatabaseSession session) : IBattleRepository, IBattleReader
{
    /// <summary>
    /// Contiene la versión y el documento almacenados de una partida.
    /// </summary>
    ...
    /// <summary>
    /// Reconstruye y valida la partida almacenada, bloqueando su fila cuando se solicita una actualización.
    /// </summary>
