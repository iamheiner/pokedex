...
/// <summary>
/// Consulta y persiste ejemplares y sus movimientos aprendidos en la transacción de la unidad de trabajo.
/// </summary>
...
{
    /// <summary>
    /// Representa la identidad, especie, nivel y salud almacenados de un ejemplar.
    /// </summary>
    private sealed record Row(Guid Id, Guid SpeciesId, string Name, int Level, int CurrentHealth, int TotalHealth);

    /// <summary>
    /// Relaciona un ejemplar con uno de sus movimientos aprendidos.
    /// </summary>
    private sealed record LearnedRow(Guid PokemonId, Guid MoveId);

    /// <summary>
    /// Reconstruye los ejemplares seleccionados con sus especies y movimientos cargados por lotes.
    /// </summary>
    ...
    /// <summary>
    /// Busca un ejemplar por su identificador y devuelve null si no existe.
    /// </summary>
