...
internal sealed class DatabaseSession(NpgsqlConnection connection, NpgsqlTransaction transaction) : IAsyncDisposable
{
    ...
    /// <summary>Rechaza el uso de una sesión cuya transacción ya ha terminado.</summary>
    internal void EnsureActive() => ObjectDisposedException.ThrowIf(completed, this);
    /// <summary>Ejecuta una consulta parametrizada con Dapper dentro de la transacción y devuelve sus filas.</summary>
    ...
    /// <summary>Ejecuta una consulta parametrizada y obtiene su primer valor dentro de la transacción.</summary>
    ...
    /// <summary>Ejecuta una instrucción parametrizada y devuelve el número de filas afectadas.</summary>
    ...
    /// <summary>Confirma la transacción y marca la sesión como terminada.</summary>
    ...
    /// <summary>Cierra la transacción y libera la conexión, revirtiendo los cambios que no se hayan confirmado.</summary>
...
{
    /// <summary>Abre una conexión y una transacción con el aislamiento solicitado, liberando la conexión si falla.</summary>
