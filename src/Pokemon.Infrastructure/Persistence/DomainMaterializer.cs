...
/// <summary>
/// Una fila inválida es corrupción de almacenamiento, no un error en la petición HTTP.
/// </summary>
internal static class DomainMaterializer
{
    /// <summary>
    /// Reconstruye un agregado y convierte las invariantes almacenadas inválidas en un error de persistencia.
    /// </summary>
