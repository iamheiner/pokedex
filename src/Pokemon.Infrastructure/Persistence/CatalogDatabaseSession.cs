...
/// <summary>
/// Bloquea el catálogo solo si una escritura lo consulta. Las partidas no adquieren este bloqueo.
/// </summary>
internal sealed class CatalogDatabaseSession(DatabaseSession database, bool readOnly)
{
    private bool locked;
    /// <summary>
    /// Comprueba la sesión y adquiere una sola vez el bloqueo del catálogo si la operación permite escritura.
    /// </summary>
    ...
    /// <summary>
    /// Consulta las filas del catálogo después de preparar su acceso transaccional.
    /// </summary>
    ...
    /// <summary>
    /// Obtiene un valor escalar del catálogo después de preparar su acceso transaccional.
    /// </summary>
    ...
    /// <summary>
    /// Ejecuta una instrucción sobre el catálogo y devuelve las filas afectadas dentro de la transacción.
    /// </summary>
