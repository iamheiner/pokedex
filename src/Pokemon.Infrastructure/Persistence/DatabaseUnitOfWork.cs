...
/// <summary>
/// Controla una transacción por operación, independientemente de los agregados que participen.
/// </summary>
internal sealed class DatabaseUnitOfWork(DatabaseConnectionFactory connections, RepositoryRegistry? registrations = null) : IUnitOfWork, IReadSession
{
    ...
    /// <summary>
    /// Ejecuta una consulta en una transacción de solo lectura con aislamiento repetible.
    /// </summary>
    ...
    /// <summary>
    /// Ejecuta y confirma un comando completo o revierte sus cambios si la operación falla.
    /// </summary>
