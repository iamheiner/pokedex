...
/// <summary>
/// Devuelve estado, siguiente actor, versión e historial sin ejecutar ninguna acción.
/// </summary>
public sealed class GetBattleQueryHandler(IReadSession reader) : IRequestHandler<GetBattleQuery, BattleView>
{
    /// <summary>
    /// Recupera la partida y proyecta su estado dentro de una sesión de lectura.
    /// </summary>
