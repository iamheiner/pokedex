...
{
    /// <summary>Recupera una especie o informa de que no existe para el caso de uso solicitado.</summary>
    ...
    /// <summary>Recupera un movimiento o informa de que no existe para el caso de uso solicitado.</summary>
    ...
    /// <summary>Recupera un ejemplar o informa de que no existe para el caso de uso solicitado.</summary>
    ...
    /// <summary>Proyecta los datos del movimiento a su contrato de salida.</summary>
    public static MoveView View(CatalogMove move) => new(move.Id, move.Name, move.Power, move.Type);
    /// <summary>Proyecta las seis estadísticas base a su contrato de salida.</summary>
    ...
    /// <summary>Proyecta el plan de aprendizaje ordenado por nivel e identificador de movimiento.</summary>
    ...
    /// <summary>Proyecta una colección de especies resolviendo sus movimientos en un lote.</summary>
    ...
    /// <summary>Proyecta una colección de ejemplares resolviendo sus especies y movimientos en lotes.</summary>
    ...
    /// <summary>Construye la respuesta de una especie junto con su plan de aprendizaje.</summary>
    ...
    /// <summary>Construye la respuesta de un ejemplar junto con sus estadísticas y movimientos aprendidos.</summary>
