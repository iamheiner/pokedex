...
/// <summary>Agrupa las rutas del recurso pokemon y sus contratos de error comunes.</summary>
public static class PokemonEndpoints
{
    /// <summary>Registra las consultas y comandos HTTP del recurso pokemon.</summary>
