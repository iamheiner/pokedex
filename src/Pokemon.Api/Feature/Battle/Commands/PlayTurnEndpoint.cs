...
/// <summary>Resuelve una acción y devuelve el nuevo estado.</summary>
internal static class PlayTurnEndpoint
{
    ...
    /// <summary>Resuelve una acción y devuelve el nuevo estado mediante el caso de uso de Application.</summary>
