...
{
    /// <summary>
    /// Lanza una excepción de regla de Pokédex cuando la condición indicada no se cumple.
    /// </summary>
    ...
    /// <summary>
    /// Valida la longitud del nombre y devuelve su valor sin espacios en los extremos.
    /// </summary>
    ...
    /// <summary>
    /// Rechaza un identificador vacío para las entidades de Pokédex.
    /// </summary>
