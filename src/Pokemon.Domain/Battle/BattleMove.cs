...
public sealed record BattleMove
{
    ...
    /// <summary>
    /// Crea un movimiento de combate con todos sus usos iniciales disponibles.
    /// </summary>
    public BattleMove(Guid id, Move definition) : this(id, definition, InitialUses) { }
    /// <summary>
    /// Construye un movimiento de combate con los usos indicados y valida su identidad y definición.
    /// </summary>
    ...
    /// <summary>
    /// Devuelve una nueva versión del movimiento con un uso menos o rechaza su agotamiento.
    /// </summary>
